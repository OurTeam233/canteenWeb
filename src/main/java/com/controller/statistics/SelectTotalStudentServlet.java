...
@WebServlet("/Statistic/TotalStudent")
public class SelectTotalStudentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Integer totalPrice = statisticsServiceImpl.totalStudent(storeId);
        //输出
