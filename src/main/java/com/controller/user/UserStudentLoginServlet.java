...
import com.service.StudentService.StudentServiceImpl;
...
public class UserStudentLoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Result result = userServiceImpl.selectUserStudent(sequence, department, className);
        // TODO 待修改，当前是永远成功
//        result.setSuccess(true);
        if (result.isSuccess()) {
            ...
            Student studentBySequence = studentServiceImpl.selectStudentBySequence(sequence);
            if (studentBySequence == null) {
                ...
                // 将openid等各种数据存入数据库
                studentId = studentServiceImpl.insertStudent(student);
            } else {
                // 查询到学生的studentId
